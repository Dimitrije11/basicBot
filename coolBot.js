            ...
            dimitrijeCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    	...
                    	API.sendChat("/me @" + chat.un + " Dimitrije11 je Host u sobi, napravio je sobu radi zabave, trudi se da svima pomogne i voli da jede čokoladu. :innocent: :stuck_out_tongue_winking_eye:");
                    }
                }
            },
            ...
            filippCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    	...
                    	API.sendChat("/me @" + chat.un + " Filip je Manager u sobi, brži je od svetlosti, uvek je tu i pravi je prijatelj. :+1:");
                    }
                }
            },
